...
export default class Graph extends Vue {
  ...
  /**
   * Watches for how many charts have loaded in order to toggle the loading bars
   */
  @Watch("chartsLoaded")
  ...
  /**
   * Function to populate the first GChart element, Distribution of crime by weekdays with data
   * @param chart the chart element
   * @param google google's chart API
   */
  async weekDayDistribution(chart, google) {
    ...
    for (let i = 0; i < data.length; i++) {
      const weekDay = data.find(obj => obj["WEEKDAY(crimedate)"] == i)[
        "WEEKDAY(crimedate)"
      ];
  ...
  /**
   * Function to populate the second GChart element, Distribution of crime by weapons
   * @param chart the chart element
   * @param google google's chart API
   */
  ...
  /**
   * Function to populate the third GChart element, Distribution of crime by districts
   * @param chart the chart element
   * @param google google's chart API
   */
  ...
  /**
   * Function to populate the fourth GChart element, Distribution of crime by description
   * @param chart the chart element
   * @param google google's chart API
   */
  ...
  /**
   * Function to populate the fifth GChart element, Trend of crime over years
   * @param chart the chart element
   * @param google google's chart API
   */
  ...
  /**
   * Function to populate the sixth and last GChart element, Trend of crime by time of day
   * @param chart the chart element
   * @param google google's chart API
   */
